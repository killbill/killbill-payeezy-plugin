...
public class PayeezyPaymentMethodPlugin extends PluginPaymentMethodPlugin {

    public PayeezyPaymentMethodPlugin(final PayeezyPaymentMethodsRecord record) {
        super(record.getKbPaymentMethodId() == null ? null : UUID.fromString(record.getKbPaymentMethodId()),
              record.getToken(),
              (record.getIsDefault() != null) && PayeezyDao.TRUE == record.getIsDefault(),
