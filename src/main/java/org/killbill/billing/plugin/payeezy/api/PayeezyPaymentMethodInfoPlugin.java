...
public class PayeezyPaymentMethodInfoPlugin extends PluginPaymentMethodInfoPlugin {

    public PayeezyPaymentMethodInfoPlugin(final PayeezyPaymentMethodsRecord record) {
        super(UUID.fromString(record.getKbAccountId()),
              UUID.fromString(record.getKbPaymentMethodId()),
              record.getIsDefault() == PayeezyDao.TRUE,
              record.getToken());
    }
}
