...
public class TestPayeezyPaymentPluginApi extends TestRemoteBase {
    ...
    public void testAuthorizeCaptureAndRefund() throws Exception {
        ...
        final Payment payment = doAuthorize(BigDecimal.TEN, PluginProperties.buildPluginProperties(ImmutableMap.<String, String>of(PayeezyPaymentPluginApi.PROPERTY_CC_VERIFICATION_VALUE, CC_VERIFICATION_VALUE)));
    ...
    public void testPurchaseAndRefund() throws Exception {
        ...
        final Payment payment = doPurchase(BigDecimal.TEN, PluginProperties.buildPluginProperties(ImmutableMap.<String, String>of(PayeezyPaymentPluginApi.PROPERTY_CC_VERIFICATION_VALUE, CC_VERIFICATION_VALUE)));
        doRefund(payment, BigDecimal.TEN);
    }
